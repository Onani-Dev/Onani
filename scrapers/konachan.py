...
def scrape(query):
    ...
    while system.values.scraping:
        page += 1
        try:
            src = s.get("http://konachan.com/post.json", params={"tags": query, "page": page, "limit": 100}, timeout=60)
        ...
        for image in data:
            try:
                img = {
                    ...
                    "sources": [f"http://konachan.com/post/show/{image['id']}/", image["source"], image["file_url"]],
