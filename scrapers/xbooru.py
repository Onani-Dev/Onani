...
def scrape(query):
    ...
    while system.values.scraping:
        try:
            src = s.get("https://xbooru.com/index.php", params={"page": "dapi", "s": "post", "q": "index", "json": 1, "tags": query, "pid": page}, timeout=60)
        ...
        for image in data:
            try:
                img = {
                    ...
                    "sources": [f"https://xbooru.com/index.php?page=post&s=view&id={image['id']}", f'{home_page}images/{image["directory"]}/{image["image"]}'],
