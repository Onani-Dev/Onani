# -*- coding: utf-8 -*-
"""Tests for services: create_ban, delete_ban, create_user, determine_meta_tags, query_posts."""
import pytest


class TestCreateUser:
    def test_create_user_basic(self, app, db):
        from onani.services.users import create_user
...
class TestBanService:
    def test_create_ban(self, app, db, make_user):
        ...
        from onani.services.bans import create_ban
        ...
        ban = create_ban(banner, target.id, future, "Test reason", False, False)
    ...
    def test_delete_ban(self, app, db, make_user):
        ...
        from onani import db as _db
        from onani.services.bans import delete_ban
    ...
    def test_ban_user_not_found(self, app, db, make_user):
        ...
        with pytest.raises(LookupError):
            create_ban(banner, 99999, None, "reason", False, False)
