...
function init() {
  ...
  socket.on("message", function (message) {
    ...
    AddChatMessage(
      `<a style="text-decoration:none;cursor:pointer;" title="Double click to view profile, or Right click to open profile in a new tab." onauxclick="window.open('/users/${message.user_id}', '_blank').focus();" ondblclick="location.href='/users/${message.user_id}'"><b>${message.user}:</b></a> ${msg}`
    );
  });
